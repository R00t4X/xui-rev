...
while ! wget -q --progress=dot:mega --timeout=30 --tries=10 --retry-connrefused https://raw.githubusercontent.com/R00t4X/xui-rev/refs/heads/main/bot/xui-rp-bot.py -O /usr/local/xui-rp/xui-rp-bot.py; do
